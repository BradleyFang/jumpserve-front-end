...
export default async function Home() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_10%_12%,#99f6e4_0%,transparent_42%),radial-gradient(circle_at_82%_20%,#fcd34d_0%,transparent_38%),radial-gradient(circle_at_70%_88%,#93c5fd_0%,transparent_35%),#f8fafc] p-5 dark:bg-[radial-gradient(circle_at_10%_12%,#0f766e_0%,transparent_38%),radial-gradient(circle_at_82%_20%,#854d0e_0%,transparent_35%),radial-gradient(circle_at_70%_88%,#1d4ed8_0%,transparent_35%),#020617] sm:p-10">
      <div className="mx-auto flex w-full items-start justify-center py-3 sm:py-8">
        {mergedParentRuns.length > 0 ? (
          ...
          <section className="w-full max-w-4xl rounded-3xl border border-slate-200 bg-white/85 p-10 text-center shadow-xl dark:border-slate-700 dark:bg-slate-900/85">
